...
| TP10 (28 Abril) | Trabalho autónomo |
| TP11 + E3 (13 Maio) | Apresentações e entrega final |
...
::: {.column width="45%"}
1. Commit de todos os ficheiros
2. Push para `main`
...
::: {.column width="55%"}
![](ficheiros/img/github-pages-settings.png){fig-alt="Página Settings > Pages com Source: GitHub Actions"}
:::
...
jobs:
  build-deploy:
    ...
    steps:
      ...
      - uses: quarto-dev/quarto-actions/setup@v2      # <5>
      - run: quarto render                            # <6>
...
4. Instala R e pacotes.
5. Instala Quarto.
6. Renderiza o site.
7. Publica o output na branch `gh-pages`.
...
# TP10: trabalho autónomo {background-color="#2C3E50"}

## 28 de Abril: sem aula presencial

Trabalham autonomamente no site do ensaio.

## Checklist da TP10

1. Criar projecto Quarto website
2. Integrar protocolo (E1)
3. Integrar materiais (E2)
4. Analisar o dataset do cenário

## Checklist da TP10 (cont.)

5. Criar tabela e gráfico
6. Integrar resultados
7. Preencher página equipa
8. Rever estilo e coesão

## Checklist da TP10 (fim)

9. `quarto render`, commit, push
10. Verificar o deploy
11. Partilhar link no Moodle

## Dataset do vosso cenário

Descarregar de `ficheiros/` neste site:

- RespiRA: `respira.csv`
- MindMove: `mindmove.csv`
- GlucoCheck: `glucocheck.csv`
...
- **Esta semana**: rever o guião e fazer o exercício
- **28 Abril (TP10)**: trabalho autónomo
- **1 Maio**: entrega do site no Moodle
- **13 Maio (TP11)**: apresentações finais
